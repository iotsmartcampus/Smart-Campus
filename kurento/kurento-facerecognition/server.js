...
kurento.register('kurento-module-facerecognition');
//kurento.register('kurento-module-maskdetection');
...
function createMediaElements(pipeline, ws, callback) {
    pipeline.create('WebRtcEndpoint', function(error, webRtcEndpoint) {
        ...
        var options = {}
        pipeline.create('facerecognition.FaceRecognition', options, function(error, filter) {
            if (error) {
                return callback(error);
            }
...
function connectMediaElements(player,webRtcEndpoint, filter, callback) {
...
player.play(function(error){
	...
	setInterval(function(){
	    filter.setConfig("/home/david/Documentos/SmartCampus/kurento/faces", numOpFilter, nameCadFilter,function(){
