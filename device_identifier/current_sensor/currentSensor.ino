...
//MQTT Server
const char* BROKER_MQTT = "10.0.0.182";                          //URL do broker MQTT
int BROKER_PORT = 1883;                                             // Porta do Broker MQTT

#define ID_MQTT  "currentSensor001001007_device"                                   //ID unico e seu
#define TOPIC_PUBLISH "/scggokgpepnvsb2uv4s40d59oo/currentSensor001001007/attrs"   //Tópico de publicação
#define TOPIC_SUBSCRIBE "/scggokgpepnvsb2uv4s40d59oo/currentSensor001001007/cmd"   //Tópico de Assinatura
